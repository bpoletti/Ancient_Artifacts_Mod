...
public class ModBlocks {
    ...
    new Block(FabricBlockSettings.of(Material.STONE).strength(2f).requiresTool()), ModItemGroup.ARTIFACTS);

    public static final Block CHACHAPOYAN_IDOL = registerBlock("chachapoyan_idol",
    new ChachapoyanIdol(FabricBlockSettings.of(Material.METAL).luminance(8).strength(3f).
            requiresTool().nonOpaque()), ModItemGroup.ARTIFACTS);

    public static final Block GILDED_PLATE = registerBlock("gilded_plate",
            new GildedPlate(FabricBlockSettings.of(Material.STONE).strength(1f).requiresTool()), ModItemGroup.ARTIFACTS);

    public static final Block DRAGON_PEDESTAL = registerBlock("dragon_pedestal",
            new DragonPedestal(FabricBlockSettings.of(Material.STONE).strength(2f).requiresTool()), ModItemGroup.ARTIFACTS);

    public static final Block ETHER_LEVER = registerBlock("ether_lever",
            new EtherLever(FabricBlockSettings.of(Material.STONE).strength(1f).requiresTool()), ModItemGroup.ARTIFACTS);
    public static final Block TOTEM_OF_ORDER = registerBlock("totem_of_order",
            new TotemOrder(FabricBlockSettings.of(Material.METAL).strength(1f).requiresTool()), ModItemGroup.ARTIFACTS);
    public static final Block TOTEM_OF_CHAOS = registerBlock("totem_of_chaos",
            new TotemChaos(FabricBlockSettings.of(Material.METAL).strength(1f).requiresTool()), ModItemGroup.ARTIFACTS);

    public static final Block COPPER_WIRE = registerBlock("copper_wire",
            new CopperWire(FabricBlockSettings.of(Material.METAL).strength(1f).requiresTool()), ModItemGroup.ARTIFACTS);
